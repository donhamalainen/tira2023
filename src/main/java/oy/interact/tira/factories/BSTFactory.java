...
public class BSTFactory {
	...
	// You may create the functionality that analyses a BST using the Visitor
	// pattern
	...
	public static <K extends Comparable<K>, V> Visitor<K, V> createBSTToDotFileTreeVisitor(String graphName,
