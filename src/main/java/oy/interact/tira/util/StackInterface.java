 ...
 * TODO: Implement this interface in a separate
 * <code>StackImplementation.java</code> file.
 * 
 */
public interface StackInterface<E> {
    ...
    * 
    * If the internal array does not have enough room for the element, the
    * implementation MUST
    * first create a larger array, copy the elements from the old array to the new
    * array,
    * and then replace the old array with the new array. Then place the element in
    * the array.
    *
    * @param element The element to push, must not be null, if it is, throw
    *                NullPointerException.
    * @throws OutOfMemoryError     if no additional room can be allocated for the
    *                              stack
